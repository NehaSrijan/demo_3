  qwdqwesdf123asdsdfasdScenario: Redirection from homepage to About-us page.
    Given I am on "/"
  ...
  Scenario: Resource block
    ...
    Thenasd I should see CSS ".row>.col-3:nth-child(2)" in the "about_us_page_resource_block_row" region
   asd Then I should see CSS ".row>.col-3:nth-child(3)" in the "about_us_page_resource_block_row" region
